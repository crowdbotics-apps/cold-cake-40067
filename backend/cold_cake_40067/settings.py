"""
Django settings for cold_cake_40067 project.
...
ROOT_URLCONF = 'cold_cake_40067.urls'
...
WSGI_APPLICATION = 'cold_cake_40067.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_cake_40067 API",
    "DESCRIPTION": "API documentation for cold_cake_40067 App",
    "VERSION": "v1",
}
